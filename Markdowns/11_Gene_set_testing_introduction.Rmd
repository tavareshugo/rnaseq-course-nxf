...
set.seed(1)
tab <- readRDS("preprocessed/r_objects/res_infected_vs_uninfected_d11_annotated_shrink.rds") %>% 
    slice(1:150) %>% 
...
<div style="width: 80%; margin-left: 13%">
```{r FoldchangesSorted, echo = FALSE, dpi = 300, fig.width= 4, fig.height=2.5, warning=FALSE, message=FALSE}
tab %>% 
...
<div style="width: 80%; margin-left: 13%">
```{r FoldchangesWithGeneSet, echo = FALSE, dpi = 300, fig.width= 4, fig.height=2.5, warning=FALSE, message=FALSE}
tab %>%  
  ggplot(aes(x = Index2, y = log2FoldChange)) +
...
<div style="width: 80%; margin-left: 13%">
```{r Ranking, echo = FALSE, dpi = 300, fig.width= 4, fig.height=2.5, warning=FALSE, message=FALSE}
tab %>%  
  ggplot(aes(x = Index2)) +
...
<div style="width: 80%; margin-left: 13%">
```{r genesetB, echo=FALSE, dpi = 300, fig.width= 4, fig.height=2.5, message=FALSE, warning=FALSE}
tab %>% 
    ggplot(aes(x = Index2)) +
...
```{r pvalue, echo=FALSE, message=FALSE, warning=FALSE}
