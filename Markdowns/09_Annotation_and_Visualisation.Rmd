...
res_infected_vs_uninfected_d11 <- readRDS("preprocessed/r_objects/res_infected_vs_uninfected_d11.rds")
res_infected_vs_uninfected_d33 <- readRDS("preprocessed/r_objects/res_infected_vs_uninfected_d33.rds")
```
...
annot <- annot %>%
  ...
  filter(gene_id %in% rownames(res_infected_vs_uninfected_d11))
```
...
annot <- annotations %>%
  ...
  dplyr::filter(gene_id %in% rownames(res_infected_vs_uninfected_d11))
```
:::
...
res_d11_annot <- as.data.frame(res_infected_vs_uninfected_d11) %>% 
...
write_tsv(res_d11_annot, "results/res_infected_vs_uninfected_d11_annotated.tsv")
```
...
res_d11_shrink <- lfcShrink(dds, 
                            res = res_infected_vs_uninfected_d11,
                            type = "ashr")
...
par(mfrow=c(1,2))
plotMA(res_infected_vs_uninfected_d11, alpha=0.05)
...
res_d33_shrink <- lfcShrink(dds, 
                            res = res_infected_vs_uninfected_d33,
                            type = "ashr")
...
```{r echo=FALSE}
tibble(Geneid = rownames(res_infected_vs_uninfected_d11)) %>% 
  mutate(Upregulated_11 = res_infected_vs_uninfected_d11$padj < 0.05 & 
         !is.na(res_infected_vs_uninfected_d11$padj) & 
         res_infected_vs_uninfected_d11$log2FoldChange > 0) %>% 
  mutate(Downregulated_11 = res_infected_vs_uninfected_d11$padj < 0.05 & 
         !is.na(res_infected_vs_uninfected_d11$padj) & 
         res_infected_vs_uninfected_d11$log2FoldChange < 0) %>%
  mutate(Upregulated_33 = res_infected_vs_uninfected_d33$padj < 0.05 & 
         !is.na(res_infected_vs_uninfected_d33$padj) & 
         res_infected_vs_uninfected_d33$log2FoldChange > 0) %>%
  mutate(Downregulated_33 = res_infected_vs_uninfected_d33$padj < 0.05 & 
         !is.na(res_infected_vs_uninfected_d33$padj) & 
         res_infected_vs_uninfected_d33$log2FoldChange < 0) 
```
...
vennDat <- tibble(Geneid = rownames(res_infected_vs_uninfected_d11)) %>% 
...
saveRDS(res_d11_annot, file="results/r_objects/res_infected_vs_uninfected_annotated.rds")
saveRDS(res_d11_shrink_annot, file="results/r_objects/res_infected_vs_uninfected_annotated.rds")
saveRDS(res_d11_shrink_annot, file="results/r_objects/res_infected_vs_uninfected_annotated.rds")
```
