...
* If your current directory is not `Course_Materials/week1_bulk/course_bulk`, then navigate to the **Course_Materials** directory using the `cd` (**c**hange **d**irectory) command: `cd ~/Course_Materials/week1_bulk/course_bulk`
...
```bash
cd ~/Course_Materials/week1_bulk/course_bulk
```
