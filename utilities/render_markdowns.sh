...
for i in Markdowns/01_Introduction_to_RNAseq_Methods.Rmd Markdowns/02_FastQC_introduction.Rmd Markdowns/03_Quantification_with_Salmon_introduction.Rmd Markdowns/04_Quality_Control_introduction.Rmd Markdowns/04b_nextflow_rnaseq_introduction.Rmd Markdowns/06_Introduction_to_RNAseq_Analysis_in_R.Rmd Markdowns/10_Gene_set_testing_introduction.Rmd
do
