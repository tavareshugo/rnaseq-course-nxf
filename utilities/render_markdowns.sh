...
for i in Markdowns/01_Introduction_to_RNAseq_Methods.Rmd Markdowns/02_FastQC_introduction.Rmd Markdowns/03_Quantification_with_Salmon_introduction.Rmd Markdowns/04_Quality_Control_introduction.Rmd Markdowns/04b_nextflow_rnaseq_introduction.Rmd Markdowns/05_Data_Exploration_slides.Rmd Markdowns/06_Introduction_to_RNAseq_Analysis_in_R.Rmd Markdowns/09_Annotation_Slides.Rmd Markdowns/11_Gene_set_testing_introduction.Rmd
do
